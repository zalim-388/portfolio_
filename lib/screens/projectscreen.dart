          ...
          child: Column(
            ...
            children: [
              ...
              _buildProjectSection(
                context,
                isMobile: isMobile,
                imagePath: "assets/image/eco eats.png",
                title: " EcoEats – Grocery Shopping App",
                descriptions:
                    "Developed a feature-rich grocery shopping app using Flutterfocused on clean UI and seamless UX.Integrated Razorpay forsecure payment handling and used SharedPreferences for persistent user session and cart data storage.",
                tech: ["Dart", "Android"],
                githubUrl: "https://github.com/zalim-388/ecoeates.git",
                isReverse: true,
              ),
              SizedBox(height: 70),
            ],
